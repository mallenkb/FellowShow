...
export const DEFAULT_TIMER_FONT_FAMILY = "Geist Variable"
...
export const BROADCAST_FONT_FAMILIES: BroadcastFontOption[] = [
  ...
  { value: "Source Serif 4 Variable", label: "Source Serif 4", category: "serif" },
  { value: "Georgia", label: "Georgia", category: "serif" },
  { value: "Times New Roman", label: "Times New Roman", category: "serif" },
  { value: "Palatino", label: "Palatino", category: "serif" },
  { value: "Baskerville", label: "Baskerville", category: "serif" },
  { value: "Brush Script MT", label: "Brush Script MT", category: "handwritten" },
...
export function getFontFallback(fontFamily: string): string {
  const category = BROADCAST_FONT_FAMILIES.find((font) => font.value === fontFamily)?.category
